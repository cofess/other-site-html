...
(function(e) {
    function J(a, b) {
        ...
        c.each(function() {
            ...
            setTimeout(function() {
                ...
                b.responsive && (f = parseInt(f / (b.origWidth / b.width), 10), c = parseInt(c / (b.origWidth / b.width), 10));
                var g = 1; ! 0 == a.isVideoPlaying && (g = 0);
                l.animate({
                    opacity: g,
                    left: f + "px",
                    top: c + "px"
                ...
                function() { ! 0 == a.isVideoPlaying && e(a.currentImg.attr("data-text-id")).children().css("opacity", 0)
                })
            },
    ...
    function L(a, b, c) {
        ...
        for (var f = !0,
        h = 0; h < b.numberOfStripes; h++) h == b.numberOfStripes - 1 && (F = a.width() - u * (b.numberOfStripes - 1)),
        !b.responsive || -1 == g || -1 != g && 9 <= g ? -1 != t.indexOf("ipad") || -1 != t.indexOf("iphone") || -1 != t.indexOf("ipod") || -1 != t.indexOf("webos") ? f = !1 : a.append(e('<div class="stripe"></div>').css({
            opacity: "0",
            left: u * h + "px",
            width: F + "px",
            height: "0px",
        ...
        f || (mleft = -1 * u * h, a.append(e('<div class="stripe"><img src="' + c.current_imgInside.attr("src") + '" width="' + b.width + '" height="' + b.height + '" style="margin-left:' + mleft + 'px;"></div>').css({
            opacity: "0",
            left: u * h + "px",
            width: F + "px",
            height: "0px"
    ...
    function B(a, b, c, g, f, h, l, D) {
        ...
        if (r) {
            ...
            c.effectIsRunning = !0;
            if ("fade" == f || "slideFromLeft" == f || "slideFromRight" == f || "slideFromTop" == f || "slideFromBottom" == f) L(h, b, c),
            g = e(".stripe:first", h),
            "fade" == f && (g.css({
                top: "0px",
                height: "100%",
            ...
            0 <= f.indexOf("Stripes") && (L(h, b, c), g = 0 <= f.indexOf("Reverse") ? e(".stripe", h).myReverse() : e(".stripe", h), m = 100, i = 0, g.each(function() {
                var a = e(this); ("topBottomDroppingStripes" == f || "topBottomDroppingReverseStripes" == f) && a.css({
                    top: "0px"
            ...
            if (0 <= f.indexOf("Blocks")) {
                ...
                v = 0,
                x = !0,
                z = 0; z < b.numberOfRows; z++) for (var y = 0; y < b.numberOfColumns; y++) k = l * y,
                v = D * z,
                a = y == b.numberOfColumns - 1 ? b.width - l * (b.numberOfColumns - 1) : l,
                r = z == b.numberOfRows - 1 ? b.height - D * (b.numberOfRows - 1) : D,
                !b.responsive || -1 == g || -1 != g && 9 <= g ? -1 != t.indexOf("ipad") || -1 != t.indexOf("iphone") || -1 != t.indexOf("ipod") || -1 != t.indexOf("webos") ? x = !1 : h.append(e('<div class="block"></div>').css({
                    opacity: "0",
                    left: k + "px",
                    top: v + "px",
                    width: a + "px",
                ...
                x || (mleft = -1 * k, mtop = -1 * v, h.append(e('<div class="block"><img src="' + c.current_imgInside.attr("src") + '" width="' + b.width + '" height="' + b.height + '" style="margin-left:' + mleft + "px; margin-top:" + mtop + 'px;"></div>').css({
                    opacity: "0",
                    left: k + "px",
                    top: v + "px",
                    width: a + "px",
                ...
                if ("randomBlocks" == f) {
                    ...
                    for (I(p, 0, 0, b, h); n < b.numberOfRows - 1 || q < b.numberOfColumns - 1;) {
                        ...
                        j = 0;
                        for (n < q && b.numberOfRows < b.numberOfColumns && (j = q - n); 0 <= i && j <= q;) p = e(A[i--][j++]),
                        I(p, i, j, b, h)
                    }
                    ...
                    for (limit_j = q - n; limit_i < n && limit_j < q;) {
                        i = n + 1;
                        for (j = limit_j; i > limit_i && j < q;) i -= 1,
                        j += 1,
                        p = e(A[i][j]),
                        I(p, i, j, b, h);
                        limit_i++;
    ...
    e.fn.allinone_bannerRotator = function(a) {
        ...
        return this.each(function() {
            ...
            b.css("display", "block");
            var c = e("<div></div>").addClass("allinone_bannerRotator").addClass(a.skin),
